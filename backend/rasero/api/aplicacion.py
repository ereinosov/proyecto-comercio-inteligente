...
def registrar_rutas() -> None:
    ...
    from rasero.api.traspasos import router as router_traspasos
    from rasero.api.competencia import router as router_competencia
    from rasero.api.sincronizacion import router as router_sincronizacion
    ...
    from rasero.api.caja import router as router_caja
    from rasero.api.pagos import router as router_pagos
    from rasero.api.administracion import router as router_administracion
    from rasero.api.reportes import router as router_reportes
    from rasero.api.facturas import router as router_facturas
    ...
    app.include_router(router_traspasos)
    app.include_router(router_competencia)
    app.include_router(router_sincronizacion)
