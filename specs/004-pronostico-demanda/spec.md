...
- **Constitución vigente citada**: v2.2.6. La enmienda que esta funcionalidad motivó es la v2.2.4
  (añade `sustitucion_producto` a la tabla de Propiedad de Datos de 004; ver plan.md y research.md
  #2); v2.2.5 (entrada de `005-promociones-inteligentes`) y v2.2.6 (entrada de `007-pagos-seguridad`)
  son correcciones posteriores sobre entradas de otros módulos, sin efecto sobre este módulo.
