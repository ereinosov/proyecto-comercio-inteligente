...
- **Constitución vigente citada**: v2.2.5. La enmienda que esta funcionalidad motivó es la v2.2.4
  (añade `sustitucion_producto` a la tabla de Propiedad de Datos de 004; ver plan.md y research.md
  #2); v2.2.5 es una corrección posterior sobre la entrada de `005-promociones-inteligentes`, sin
  efecto sobre este módulo.
