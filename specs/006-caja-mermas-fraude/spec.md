...
1. **Campos y tablas de `001` que ya existen para esto** (verificado contra
   `001/data-model.md`, constitución v2.3.0): `existencia` (agregación derivada, sin restricción de
...
**Propiedad de datos — estado frente a la constitución (v2.3.0)**: la tabla de Propiedad de Datos
...
- **Constitución vigente citada**: v2.3.0. Este módulo **no motivó ninguna enmienda** (v2.2.6,
  sobre `007`, y v2.3.0, Principio VI sobre el esquema de `operador` de `001`, son posteriores y
  sin efecto estructural sobre este módulo más allá de usar `requiere_rol`): sus tres
